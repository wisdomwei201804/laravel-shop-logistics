...
class Logistics implements LogisticsContract
{
    ...
    private function getLogisticsCostMaxValue($data)
    {
        ...
        foreach ($data as $item){
            ...
            if( isset($logisticsRegexp['base_logistics_amount']) ){
                $base_logistics_amount_arr[] = $logisticsRegexp['base_logistics_amount'];
            }
            // 启用楼层费用
            if( isset($logisticsRegexp['enable_carry_way']) && $logisticsRegexp['enable_carry_way'] ){
                $start_floor_arr[] = $logisticsRegexp['start_floor'];
                $floor_carry_amount_arr[] = $logisticsRegexp['floor_carry_amount'];
            }
        }
    ...
    {
        $data['carry_amount'] = 0;
        //$data['logistics_amount'] = $data['base_logistics_amount'];
        ...
        //$data['logistics_amount'] = $data['base_logistics_amount'] + $data['carry_amount'];
        return $data;
    }
